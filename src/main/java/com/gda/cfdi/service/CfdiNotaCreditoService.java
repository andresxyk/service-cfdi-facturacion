...
@Service
public class CfdiNotaCreditoService {
...
//		timbrado.cadena.notacredito.concepto=@codigoConcepto@|@cantidad@|@cveUnidad@|@descripcion@|@iva@|
		try {			
			...
			DatosMarcaDto datosMarcaDto = utilsService.obtenerDatosMarcaAnticipada(cmarca, razonSocialJen);
			
			Comprobante cfdi33 = new Comprobante();
			cfdi33.setVersion("3.3");
			cfdi33.setFolio(String.valueOf(creditoEntityDto.getUfoliofactura()));
			cfdi33.setSerie(creditoEntityDto.getSserie());
			...
			cfdi33.setTipoDeComprobante(CTipoDeComprobante.E);
			cfdi33.setTotal(creditoEntityDto.getMtotal().setScale(2, BigDecimal.ROUND_HALF_UP));
...
//				cfdi33.setLugarExpedicion("11560");// siempre es el mismo CP ya que siempre se expide en OMEGA
			...
			cfdi33.setSubTotal(importePadre);
			...
			mx.gob.sat.cfd._3.Comprobante.Impuestos impuestos2 = new mx.gob.sat.cfd._3.Comprobante.Impuestos();
			mx.gob.sat.cfd._3.Comprobante.Impuestos.Traslados traslados2 = new mx.gob.sat.cfd._3.Comprobante.Impuestos.Traslados();
...
//			lstTrasladosTotales.add(trasladosTotales);
			...
			if(creditoDto.isRetencion()){
				mx.gob.sat.cfd._3.Comprobante.Impuestos.Retenciones retenciones2 = new mx.gob.sat.cfd._3.Comprobante.Impuestos.Retenciones();
				List<mx.gob.sat.cfd._3.Comprobante.Impuestos.Retenciones.Retencion> lstRetencionesTotales = new ArrayList<mx.gob.sat.cfd._3.Comprobante.Impuestos.Retenciones.Retencion>();
				mx.gob.sat.cfd._3.Comprobante.Impuestos.Retenciones.Retencion retencionTotales = new mx.gob.sat.cfd._3.Comprobante.Impuestos.Retenciones.Retencion();
			...
			cfdi33.setImpuestos(impuestos2);
			
			String xml = utilsService.createXmlFromComprobante(cfdi33);
			cfdi33.setCertificado(utilsService.getCertificadoB64(datosMarcaDto.getRutaCer()));
			String cadenaOriginal = utilsService.createCadenaOriginal(xml, datosMarcaDto.getRutaCadenaOriginal());
			cfdi33.setSello(utilsService.createSello(cadenaOriginal, datosMarcaDto.getRutaKey(), datosMarcaDto.getPasword()));
			
			String xmlOriginalSello =  utilsService.createXmlFromComprobante(cfdi33);
