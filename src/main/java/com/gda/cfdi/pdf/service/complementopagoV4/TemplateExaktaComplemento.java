...
public class TemplateExaktaComplemento  extends PdfPageEventHelper{
...
//	float[] medidaCeldas = {0.5f};
	private static final Logger log = LoggerFactory.getLogger(TemplateExaktaComplemento.class);
	public TemplateExaktaComplemento(Comprobante comprobante, ComplementoDatosDto complementoDatos, Environment env) throws Exception{
		try {
...
//			String sello1 = timbreFiscalDigital.getSelloSAT();
			...
			BaseColor colorFondoTituloFactPago = WebColors.getRGBColor("#d1cfcf");
