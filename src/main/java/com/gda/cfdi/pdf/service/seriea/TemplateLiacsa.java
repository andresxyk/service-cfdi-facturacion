...
public class TemplateLiacsa  extends PdfPageEventHelper{
	...
	public TemplateLiacsa(PdfInfoDto infoPDF, Comprobante comprobante, boolean retencion, boolean bDirFiscal, Environment env) throws Exception{
		try {
			if(retencion){
...
//			CRegimenFiscal cregimenfiscal = emisor.getRegimenFiscal();
			...
			//////////////////	Direccion del PDF
			///////////////////////////////////////////////////////////////////////////////////////////////            
            PdfPCell direccionSucursal = new PdfPCell(new Paragraph("C. GENERAL RETANA 905, SAN FELIPE I C.P. 31203, CHIHUAHUA, CHIHUAHUA",fuenteDirSucur));
            ...
            Chunk DomicilioEmisor = new Chunk("",fuenteContenidoTab);
            Chunk datoDomicilioEmisor = new Chunk("",fuenteContenidoImporTab);
