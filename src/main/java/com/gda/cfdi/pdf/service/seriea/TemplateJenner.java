...
public class TemplateJenner extends PdfPageEventHelper{
	...
	public TemplateJenner(PdfInfoDto infoPDF, boolean razonSocial, Comprobante comprobante, 
...
//			String uuidRelacionado = comprobante.getUuidRelacionado();
			...
			imagenLogo = Image.getInstance(env.getProperty("path.file.ordenes.logo.jenner"));
            ...
            log.info("DireccionJenner::::---->>>>>>   "+infoPDF.getAdendaDireccion());
