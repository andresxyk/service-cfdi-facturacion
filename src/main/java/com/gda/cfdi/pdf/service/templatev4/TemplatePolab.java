...
public class TemplatePolab extends PdfPageEventHelper{
	...
	public TemplatePolab(Comprobante comprobante, PdfInfoDto infoPDF, Environment env) throws Exception{
		try {
			...
			/*rutaproduccion*/ imagenLogo = Image.getInstance(env.getProperty("path.file.logo.polab"));
