...
public class TemplateExakta  extends PdfPageEventHelper{
	...
	public TemplateExakta(PdfInfoDto infoPdf, mx.gob.sat.cfd._3.Comprobante comprobant33, 
...
//			String strNomOrdPac = comprobante.getConsecutivo()+" "+comprobante.getNombrepaciente();
			...
			/*rutaproduccion*/ imagenLogo = Image.getInstance(env.getProperty("path.file.ordenes.logo.exakta"));
