...
public class TemplatePromedic extends PdfPageEventHelper{
	...
	public TemplatePromedic(Comprobante comprobante, PdfInfoDto infoPDF, Environment env) throws Exception{
		try {
			...
			/*rutaproduccion*/ imagenLogo = Image.getInstance(env.getProperty("path.file.logo.promedic"));
