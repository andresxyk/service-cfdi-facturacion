...
public class TemplateAsesoresSur  extends PdfPageEventHelper{
	...
	public TemplateAsesoresSur(PdfInfoDto infoPDF, Comprobante comprobante, boolean retencion, boolean bDirFiscal, Environment env) throws Exception{
		try {
			if(retencion){
...
//			CRegimenFiscal cregimenfiscal = emisor.getRegimenFiscal();
			...
			imagenLogo = Image.getInstance(env.getProperty("path.file.ordenes.logo.asesoressur"));
