...
public class TemplateJennerLogoAztecaComplemento  extends PdfPageEventHelper{
...
//	float[] medidaCeldas = {0.5f};
	private static final Logger log = LoggerFactory.getLogger(TemplateJennerLogoAztecaComplemento.class);
	public TemplateJennerLogoAztecaComplemento(Comprobante comprobante, ComplementoDatosDto complementoDatos, Environment env) throws Exception{
		try {
...
//			String sello1 = timbreFiscalDigital.getSelloSAT();
			...
			BaseColor colorFondoTituloFactPago = WebColors.getRGBColor("#0088b9");
			...
			/*rutaproduccion*/ imagenLogo = Image.getInstance(env.getProperty("path.file.ordenes.logo.azteca"));
