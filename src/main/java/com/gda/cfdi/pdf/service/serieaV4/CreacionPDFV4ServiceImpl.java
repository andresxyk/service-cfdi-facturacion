...
//	        }
	...
	@Override
	public String CrearPdfMarcaExakta(PdfInfoDto infoPDF,Integer kfactura, String nombreArchivo, 
			boolean retencion, mx.gob.sat.cfd._4.Comprobante comprobante, boolean bDirFiscal, Environment env) throws DocumentException, SocketException, IOException{
		String ruta = "";
		PdfPTable tabDetalleMontos = new PdfPTable(3);
		PdfPTable tabDatosFactura  = null;
		...
		try {
			...
			writerPdf.setPageEvent(new TemplateExakta(infoPDF,comprobante,retencion,bDirFiscal, env));
		} catch (DocumentException e) {
			e.printStackTrace();
		} catch (Exception e) {
			// TODO Auto-generated catch block
...
//	        }
	...
	@Override
	public String CrearPdfMarcaMoreira(PdfInfoDto infoPDF,Integer kfactura, String nombreArchivo, 
			boolean retencion, mx.gob.sat.cfd._4.Comprobante comprobante, boolean bDirFiscal, Environment env) throws DocumentException, SocketException, IOException{
		String ruta = "";
		PdfPTable tabDetalleMontos = new PdfPTable(3);
		PdfPTable tabDatosFactura  = null;
		...
		try {
			writerPdf = PdfWriter.getInstance(documentReportePdf, ficheroPdf);
			writerPdf.setPageEvent(new TemplateMoreira(infoPDF,comprobante,retencion,bDirFiscal, env));
		} catch (DocumentException e) {
			e.printStackTrace();
		} catch (Exception e) {
			// TODO Auto-generated catch block
...
//	        }
	...
	@Override
	public String CrearPdfMarcaPolab(PdfInfoDto infoPDF,Integer kfactura, String nombreArchivo, 
			boolean retencion, mx.gob.sat.cfd._4.Comprobante comprobante, boolean bDirFiscal, Environment env) throws DocumentException, SocketException, IOException{
		String ruta = "";
		PdfPTable tabDetalleMontos = new PdfPTable(3);
		PdfPTable tabDatosFactura  = null;
		...
		try {
			writerPdf = PdfWriter.getInstance(documentReportePdf, ficheroPdf);
			writerPdf.setPageEvent(new TemplatePolab(infoPDF,comprobante,retencion,bDirFiscal, env));
		} catch (DocumentException e) {
			e.printStackTrace();
		} catch (Exception e) {
			// TODO Auto-generated catch block
...
//	        }
	...
	@Override
	public String CrearPdfMarcaBiomedica(PdfInfoDto infoPDF,Integer kfactura, String nombreArchivo, 
			boolean retencion, mx.gob.sat.cfd._4.Comprobante comprobante, boolean bDirFiscal, Environment env) throws DocumentException, SocketException, IOException{
		String ruta = "";
		PdfPTable tabDetalleMontos = new PdfPTable(3);
		PdfPTable tabDatosFactura  = null;
		...
		try {
			writerPdf = PdfWriter.getInstance(documentReportePdf, ficheroPdf);
			writerPdf.setPageEvent(new TemplateBiomedica(infoPDF,comprobante,retencion,bDirFiscal, env));
		} catch (DocumentException e) {
			e.printStackTrace();
		} catch (Exception e) {
			// TODO Auto-generated catch block
...
//	        }
	...
	@Override
	public String CrearPdfMarcaPromedic(PdfInfoDto infoPDF,Integer kfactura, String nombreArchivo, 
			boolean retencion, mx.gob.sat.cfd._4.Comprobante comprobante, boolean bDirFiscal, Environment env) throws DocumentException, SocketException, IOException{
		String ruta = "";
		PdfPTable tabDetalleMontos = new PdfPTable(3);
		PdfPTable tabDatosFactura  = null;
		...
		try {
			writerPdf = PdfWriter.getInstance(documentReportePdf, ficheroPdf);
			writerPdf.setPageEvent(new TemplatePromedic(infoPDF,comprobante,retencion,bDirFiscal, env));
		} catch (DocumentException e) {
			e.printStackTrace();
		} catch (Exception e) {
			// TODO Auto-generated catch block
