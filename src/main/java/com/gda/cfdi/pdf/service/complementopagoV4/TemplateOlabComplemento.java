...
public class TemplateOlabComplemento  extends PdfPageEventHelper{
...
//	float[] medidaCeldas = {0.5f};
	private static final Logger log = LoggerFactory.getLogger(TemplateOlabComplemento.class);
	public TemplateOlabComplemento(Comprobante comprobante, ComplementoDatosDto complementoDatos, Environment env) throws Exception{
		try {
...
//			String sello1 = timbreFiscalDigital.getSelloSAT();
			...
			BaseColor colorFondoTituloFactPago = WebColors.getRGBColor("#fa840f");
			...
			/*rutaproduccion*/ imagenLogo = Image.getInstance(env.getProperty("path.file.ordenes.logo.olab"));
