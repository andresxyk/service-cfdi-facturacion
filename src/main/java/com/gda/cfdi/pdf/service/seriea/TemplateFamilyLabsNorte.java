...
public class TemplateFamilyLabsNorte  extends PdfPageEventHelper{
	...
	public TemplateFamilyLabsNorte(PdfInfoDto infoPDF, Comprobante comprobante, boolean retencion, boolean bDirFiscal, Environment env) throws Exception{
		try {
			if(retencion){
...
//			CRegimenFiscal cregimenfiscal = emisor.getRegimenFiscal();
			...
			//////////////////	Direccion del PDF
			///////////////////////////////////////////////////////////////////////////////////////////////            
            PdfPCell direccionSucursal = new PdfPCell(new Paragraph("C. NICOLAS BRAVO 725, MARIA LUISA, 64040, MONTERREY, NUEVO LEON",fuenteDirSucur));
            ...
            File f = new File(env.getProperty("path.file.ordenes.qr.familylabsnorte"));
	      	GenerarQRCode qrCode = new GenerarQRCode();
	      	qrCode.generateQR(f, imgCrearQr, 600, 600);
          
      		imagenQr = Image.getInstance(env.getProperty("path.file.ordenes.qr.familylabsnorte"));
