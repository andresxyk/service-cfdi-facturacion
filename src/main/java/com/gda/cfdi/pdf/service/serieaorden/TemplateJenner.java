...
public class TemplateJenner extends PdfPageEventHelper{
	...
	public TemplateJenner(PdfInfoDto infoPdf, mx.gob.sat.cfd._3.Comprobante comprobant33, boolean retencion, 
...
//			if(comprobante.getAdendaDireccion()!=null){
...
//				    }
//				}
//				strDomicFiscalRecep = new String(caracteres);//FALTA DATO
//			}
