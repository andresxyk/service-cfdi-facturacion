...
public class TemplateAsesoresSur  extends PdfPageEventHelper{
	...
	public TemplateAsesoresSur(PdfInfoDto infoPdf, Comprobante comprobant33, 
...
//			String strNomOrdPac = comprobante.getConsecutivo()+" "+comprobante.getNombrepaciente();
			...
			/*rutaproduccion*/ imagenLogo = Image.getInstance(env.getProperty("path.file.ordenes.logo.asesoressur"));
