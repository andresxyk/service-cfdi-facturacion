...
public class TemplateOlab extends PdfPageEventHelper{
	private static final Logger log = LoggerFactory.getLogger(TemplateOlab.class);
	...
	public TemplateOlab(Comprobante comprobante, PdfInfoDto infoPDF) throws Exception{
		try {
			...
			/*rutaproduccion*/ imagenLogo = Image.getInstance("/mnt/gda/DesarrolloGDA/documentosTimbrao/imgs/OLAB.png");
