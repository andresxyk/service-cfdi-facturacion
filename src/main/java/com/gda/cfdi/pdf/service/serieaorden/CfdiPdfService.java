...
//		                              concepto.getImpuestos().getTraslados().getTraslado().get(0).getImporte();
		    ...
		    if(bDescuento){
		    	...
		    	Descuento = new PdfPCell(new Paragraph(df.format(concepto.getImpuestos().getTraslados().getTraslado().get(0).getImporte()),fuenteContenidoTab));
		    }
