...
public class TemplateMoreira  extends PdfPageEventHelper{
	private static final Logger log = LoggerFactory.getLogger(TemplateMoreira.class);
	...
	public TemplateMoreira(PdfInfoDto infoPdf, Comprobante comprobant33, 
...
//			String strNomOrdPac = comprobante.getConsecutivo()+" "+comprobante.getNombrepaciente();
			...
			/*rutaproduccion*/ imagenLogo = Image.getInstance(env.getProperty("path.file.ordenes.logo.moreira"));
