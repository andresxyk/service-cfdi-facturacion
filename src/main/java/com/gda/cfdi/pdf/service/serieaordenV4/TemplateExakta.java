...
public class TemplateExakta  extends PdfPageEventHelper{
	private static final Logger log = LoggerFactory.getLogger(TemplateExakta.class);
	...
	public TemplateExakta(PdfInfoDto infoPdf, Comprobante comprobant33, 
...
//			String strNomOrdPac = comprobante.getConsecutivo()+" "+comprobante.getNombrepaciente();
			...
			if(comprobant33.getEmisor().getRfc().equals("LBA840320GC8")) {
				imagenLogo = Image.getInstance(env.getProperty("path.file.logo.exakta.laboratorio"));				
			}else if(comprobant33.getEmisor().getRfc().equals("IME0103012D3")){
