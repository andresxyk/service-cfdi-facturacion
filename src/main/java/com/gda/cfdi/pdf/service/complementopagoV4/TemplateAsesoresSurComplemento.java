...
public class TemplateAsesoresSurComplemento  extends PdfPageEventHelper{
...
//	float[] medidaCeldas = {0.5f};
	private static final Logger log = LoggerFactory.getLogger(TemplateAsesoresSurComplemento.class);
	public TemplateAsesoresSurComplemento(Comprobante comprobante, ComplementoDatosDto complementoDatos, Environment env) throws Exception{
		try {
