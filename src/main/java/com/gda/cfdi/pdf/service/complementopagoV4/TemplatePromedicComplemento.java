...
public class TemplatePromedicComplemento  extends PdfPageEventHelper{
...
//	float[] medidaCeldas = {0.5f};
	private static final Logger log = LoggerFactory.getLogger(TemplatePromedicComplemento.class);
	public TemplatePromedicComplemento(Comprobante comprobante, ComplementoDatosDto complementoDatos, Environment env) throws Exception{
		try {
