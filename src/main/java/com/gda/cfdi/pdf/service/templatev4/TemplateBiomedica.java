...
public class TemplateBiomedica extends PdfPageEventHelper{
	...
	public TemplateBiomedica(Comprobante comprobante, PdfInfoDto infoPDF, Environment env) throws Exception{
		try {
			...
			/*rutaproduccion*/ imagenLogo = Image.getInstance(env.getProperty("path.file.logo.referencia"));
