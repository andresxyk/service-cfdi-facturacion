...
public class TemplateGenericoEmpresa extends PdfPageEventHelper{
	private static final Logger log = LoggerFactory.getLogger(TemplateGenericoEmpresa.class);
	...
	public TemplateGenericoEmpresa(Comprobante comprobante, PdfInfoDto infoPDF, Environment env) throws Exception{
		try {
...
//			if(comprobante.getEmisor().getRfc().equals("LBA840320GC8")) {
				imagenLogo = Image.getInstance(env.getProperty("path.file.logo.generico"));
