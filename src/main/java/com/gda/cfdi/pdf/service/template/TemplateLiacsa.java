...
public class TemplateLiacsa extends PdfPageEventHelper{
	...
	public TemplateLiacsa(Comprobante comprobante, PdfInfoDto infoPDF) throws Exception{
		try {
			...
			/*rutaproduccion*/ imagenLogo = Image.getInstance("/home/orubio/DesarrolloGDA/documentosTimbrao/imgs/Liacsa.jpg");
