...
public class TemplateMoreira extends PdfPageEventHelper{
	...
	public TemplateMoreira(Comprobante comprobante, PdfInfoDto infoPDF, Environment env) throws Exception{
		try {
			...
			/*rutaproduccion*/ imagenLogo = Image.getInstance(env.getProperty("path.file.logo.moreira"));
