...
public class TFacturaEntity {
	    ...
	    private BigDecimal user_id_change;
		...
		public BigDecimal getUser_id_change() {
			return user_id_change;
		}
		public void setUser_id_change(BigDecimal user_id_change) {
		...
		public String toString() {
			return "TFacturaEntity [kfactura=" + kfactura + ", kdatofiscal=" + kdatofiscal + ", ssucursal=" + ssucursal
					+ ", ufoliofactura=" + ufoliofactura + ", ccliente=" + ccliente + ", csucursal=" + csucursal
					...
					+ ssellodigital + ", centidadlegal=" + centidadlegal + ", dregistro=" + dregistro
					+ ", dcancelacionfactura=" + dcancelacionfactura + ", user_id_change=" + user_id_change + ", user_id="
					+ user_id + ", sobservacion=" + sobservacion + ", sxml=" + sxml + ", sxmlsello=" + sxmlsello
					+ ", sserie=" + sserie + ", suddi=" + suddi + ", surl=" + surl + ", cformapagocfdi=" + cformapagocfdi
					+ ", cmetodopagocfdi=" + cmetodopagocfdi + ", cusocfdi=" + cusocfdi + ", cregimenfiscal="
					+ cregimenfiscal + ", ctipocomprobantecfdi=" + ctipocomprobantecfdi + ", ctiporelacioncfdi="
					+ ctiporelacioncfdi + "]";
		}
