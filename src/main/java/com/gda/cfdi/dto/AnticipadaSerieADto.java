...
public class AnticipadaSerieADto extends FacturaDto {
	...
	public AnticipadaSerieADto() {
		super();
	}

	protected AnticipadaSerieADto(String idUsoCfdi, String formaPago, String montoTotal, Integer idMarca,
	...
	public String toString() {
		return "AnticipadaSerieADto [idConvenio=" + idConvenio + ", idUsoCfdi=" + idUsoCfdi + ", formaPago=" + formaPago
